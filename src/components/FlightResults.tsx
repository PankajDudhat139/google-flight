  ...
  if (error) {
    return (
      <div className="mt-8 flex justify-center">
        <div className="bg-red-100 border border-red-300 rounded-xl px-6 py-4 shadow-md max-w-md w-full">
    ...
    return (
      <div className="mt-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">
          Found <span className="text-blue-600">{flights.length}</span> flights
        </h2>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {flights.map((flight, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-200 border border-gray-100"
            >
  ...
  if (!loading && flights.length === 0 && !error) {
    return (
      <div className="mt-16 flex flex-col items-center justify-center py-16">
        <Plane className="w-20 h-20 text-blue-200 mb-6 animate-bounce" />
